...
export const metadata: Metadata = {
  ...
  description:
    "Car detailing packages in Melrose Park, IL: interior detailing, exterior detailing, full details, ceramic coating and paint correction. Transparent pricing for sedans, SUVs and trucks in the Chicago suburbs.",
